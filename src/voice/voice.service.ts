...
//    * STEP 5: THE EVENT HUB
//    *
//    * FIX: Added handlers for response.output_text.delta and
//    * response.output_text.done — these are the actual event names the
//    * OpenAI Realtime API emits. The original response.text.delta /
//    * response.text.done cases are kept as fallbacks for compatibility.
//    *
//    * IMPORTANT — Function call routing strategy:
//    * OpenAI Realtime can emit function calls in different event shapes
//    * depending on model/runtime behavior. We consume all supported shapes
...
//       // ─────────────────────────────────────────────────────────────────
//       // FIX: response.output_text.delta is the actual event name sent by
//       // the OpenAI Realtime API. response.text.delta is kept as a
//       // fallback in case of model/version differences.
//       // ─────────────────────────────────────────────────────────────────
...
//       // ─────────────────────────────────────────────────────────────────
//       // FIX: response.output_text.done is the actual event name sent by
//       // the OpenAI Realtime API. response.text.done is kept as a
//       // fallback in case of model/version differences.
//       // ─────────────────────────────────────────────────────────────────
